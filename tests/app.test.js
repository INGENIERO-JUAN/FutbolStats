...
describe('GET /api/posiciones', () => {
  it('Debería retornar la lista de equipos ordenada por puntos', async () => {
    ...
    // ✅ CORRECCIÓN ERROR 2: La variable NODE_ENV=test se inyecta en el workflow de CI.
    // El guard sigue activo para proteger entornos no-test.
    ...
    // ✅ CORRECCIÓN ERROR 7: Se eliminó '.colose(200)' que era un typo que rompía Jest.
